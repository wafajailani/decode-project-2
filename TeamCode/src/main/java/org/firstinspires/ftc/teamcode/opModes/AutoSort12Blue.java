...
public class AutoSort12Blue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("updated code V1 - blue");
        telemetry.update();
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        drive.actionBuilder(drive.localizer.getPose())
                                .stopAndAdd(limelight.scanAprilTag())
                                .strafeTo(new Vector2d(-14, -39.5)) //pos to shoot presets
                                .waitSeconds(0.5)
                                .stopAndAdd(robot.kUp()) //change to kUp pattern
                                .stopAndAdd(robot.backintakeIn()) //ts is acc the front intake maybe change configuration
                                .setTangent(Math.toRadians(90))
                                .lineToY(-20)
                                ...
                                //  .lineToY(-20)
                                .build() // change this to the positon of 1st spike mark to shoot presets
                        //  robot.kUp(),
                        /*drive.actionBuilder(drive.localizer.getPose())
                                .setTangent(Math.toRadians(180))
                                .lineToX(-39.5)
