...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 4639.237765693787; //3964.5882466355233; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -138.3641432814098; // -226.09365542771724;  // x position of the perpendicular encoder (in tick units)
    }
